  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-green-100 to-green-200 px-6 text-center">
      ...
      <p className="text-lg sm:text-xl max-w-2xl text-gray-800 mb-6">
        We're truly grateful you chose{" "}
        <span className="text-green-800 font-semibold">OrganicConnect</span> for
        your journey—whether to buy fresh organic produce 🌾 or to learn about a
        healthier, sustainable future.
      </p>
      <p className="text-md sm:text-lg text-gray-700 mb-8">
        Together, we support genuine organic farmers and promote conscious
        living. Thank you for being a part of our mission. 💚
      </p>
